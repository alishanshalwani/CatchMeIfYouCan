function CMain(oData){
    ...
    this._initSounds = function(){
        ...
        s_aSoundsInfo.push({path: './sounds/',filename:'fruit_slice_1',loop:false,volume:1, ingamename: 'fruit_slice_1'});
        s_aSoundsInfo.push({path: './sounds/',filename:'fruit_slice_2',loop:false,volume:1, ingamename: 'fruit_slice_2'});
        s_aSoundsInfo.push({path: './sounds/',filename:'fruit_slice_3',loop:false,volume:1, ingamename: 'fruit_slice_3'});
        s_aSoundsInfo.push({path: './sounds/',filename:'bomb_fuse',loop:false,volume:1, ingamename: 'bomb_fuse'});
        s_aSoundsInfo.push({path: './sounds/',filename:'boing_fruit',loop:false,volume:1, ingamename: 'boing_fruit'});
